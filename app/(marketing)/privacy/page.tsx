    ...
    <main className="mx-auto w-full max-w-4xl flex-1 px-6 pb-20 sm:px-8">
      ...
      <div className="max-w-2xl">
        ...
        <Section title="Who runs this">
          <p>
            Baseline is a personal project run by one individual, not a company.
            There is no team, no investor, and no third party with an interest
            in your data.
          </p>
        </Section>
        ...
        <Section title="What is collected">
          <p>
            Your first name, last name, and email address, if you type them into
            the signup form and submit it.
          </p>
          <p>Alongside them, two pieces of context are stored:</p>
          <ul className="flex flex-col gap-2 pl-5">
            <li className="list-disc">The time you submitted the form</li>
            <li className="list-disc">
              Which form you used — the one at the top of the page or the one at
              the bottom
            </li>
          </ul>
          <p>
            That second field exists so I can tell whether people sign up before
            or after reading the section describing what the application would
            capture. It tells me nothing about you personally.
          </p>
          <p>
            Beyond that and the traffic measurement described below, nothing is
            collected. There is no account, no password, no payment information,
            and no advertising or cross-site tracking cookie on this site.
          </p>
        </Section>
        ...
        <Section title="Traffic and speed measurement">
          <p>
            ...
            Neither assigns you a visitor identifier, and neither can follow you
            to any other site.
          </p>
          <p>
            What they record is which page was viewed, coarse technical context
            such as country, browser, and device type, and how quickly the page
            rendered for you.
          </p>
          <p>
            Three things the signup form does are also counted: that the button
            was pressed, that a submission succeeded, and that one failed
            together with a short category for why — a malformed address, say,
            or the storage endpoint being unreachable. These record that
            something happened and which of the two forms it happened on. They
            never include anything you typed.
          </p>
        </Section>

        <Section title="Where it goes">
          <p>
            Submitted names and addresses are stored in a private Google Sheet.
            Google processes and stores that data under its own terms, which you
            can read at{" "}
          ...
          <p>
            ...
            type, page requested, timestamp — as a normal part of serving pages.
            That is Vercel’s logging, not something added here, and it is
            covered by{" "}
          ...
          <p>
            Your details are not sold, rented, shared, or given to anyone else.
          </p>
        </Section>
        ...
        <Section title="Security">
          <p>
            ...
            two-factor authentication enabled. That is a reasonable measure for
            an email list, but no system is guaranteed secure, and it would be
            dishonest to claim otherwise.
          </p>
          <p>
            Given that the only thing stored is a name and an email address you
            already chose to hand over, the consequences of a failure here are
            small.
          </p>
        </Section>
        ...
        <Section title="About the application">
          ...
          <p>
            ...
            and there would be no server to receive it. That is a description of
            the intended design, not a commitment about a finished product, and
            this policy will be replaced with one covering the actual software
            before any build is released.
          </p>
        </Section>
        ...
        <Section title="Changes">
          <p>
            ...
            everyone on the list gets an email about it before it takes effect.
          </p>
        </Section>
